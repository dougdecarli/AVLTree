...
public class Tradutor {
	...
	protected void carregaDicionario(String filepath) throws IOException {
		...
		try(BufferedReader br = new BufferedReader(new FileReader(filepath))){
			...
			while((line = br.readLine()) != null) {
				...
				//Faz a separacao das palavras da linha para montar dicionario (palavra a cada #)
				palavras = line.split("#");
				
				Dicionario dicionario = new Dicionario(palavras);
				
				this.avl.insert(dicionario, dicionario.palavra);
	...
	public void insereTraducao(String palavra, List<String> definicoes) {
		...
		Dicionario dicionario = new Dicionario(palavras);
		this.avl.insert(dicionario, dicionario.getPalavra());
		this.avl.inOrder();
	...
	public void salvaDicionario(String filepath) throws IOException {
		try(BufferedWriter bw = new BufferedWriter(new FileWriter(filepath))){
			List<String> dicionario = this.avl.getAllDicionarios();
